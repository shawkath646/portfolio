...
// Using useMemo would be better if these were fetched from an API
const tasks = [
...
const TaskItem = memo(function TaskItem({ 
  ...
  return (
    ...
    >
      <motion.span 
        className={`inline-block w-5 h-5 border-2 border-white rounded-sm ${priority.class}`}
...
const TasksBoard = memo(function TasksBoard() {
  ...
  // Memoized tasks with proper type
  const typedTasks = useMemo(() => tasks as Task[], []);
  ...
  return (
    ...
    >
      ...
      <ul 
        className="space-y-5 pl-4 relative z-10"
