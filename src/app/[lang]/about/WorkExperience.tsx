        ...
        >
            ...
            >
                <div className="relative inline-flex items-center justify-center">
                    <div className="absolute inset-0 bg-linear-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-lg blur opacity-30 animate-pulse"></div>
            ...
            <div className="relative">
                ...
                <motion.div 
                    className="absolute left-2.75 top-0 bottom-0 w-0.5 bg-linear-to-b from-emerald-300/0 via-emerald-500/50 to-emerald-300/0 dark:from-emerald-700/0 dark:via-emerald-400/30 dark:to-emerald-700/0 z-0 md:hidden origin-top"
                    variants={lineVariants}
                    initial="hidden"
                    animate={inView ? "visible" : "hidden"}
                />
                            ...
                            <div className={`hidden md:flex items-center ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                                ...
                                >
                                    <div className="relative">
                                        ...
                                        {/* Main dot */}
                                        <div className="relative w-6 h-6 rounded-full bg-linear-to-br from-emerald-400 to-teal-500 dark:from-emerald-500 dark:to-teal-600 flex items-center justify-center shadow-lg border-4 border-white dark:border-gray-900">
                                ...
                                <motion.div
                                    className={`absolute top-8 h-0.5 bg-linear-to-r ${index % 2 === 0 ? 'right-1/2 mr-3 from-emerald-400/40 to-transparent' : 'left-1/2 ml-3 from-transparent to-emerald-400/40'} dark:from-emerald-500/40 dark:to-transparent`}
                                ...
                                <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 flex justify-end' : 'pl-8 flex justify-start'}`}>
                                    ...
                                    >
                                        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-5 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 relative overflow-hidden group">
                                            ...
                                            <motion.div 
                                                className={`absolute top-0 left-0 w-full h-1 ${index % 2 === 0 ? 'bg-linear-to-r from-emerald-400 to-teal-500' : 'bg-linear-to-r from-teal-500 to-emerald-400'}`}
                                                initial={{ scaleX: 0 }}
                                            ...
                                            {/* Hover glow effect */}
                                            <div className="absolute inset-0 bg-linear-to-br from-emerald-500/0 via-teal-500/0 to-emerald-500/0 group-hover:from-emerald-500/5 group-hover:via-teal-500/5 group-hover:to-emerald-500/5 transition-all duration-500 rounded-xl"></div>
                            ...
                            <div className="md:hidden flex items-start gap-4">
                                ...
                                >
                                    <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-4 sm:p-5 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 relative overflow-hidden group">
                                        {/* Top gradient indicator */}
                                        <motion.div 
                                            className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-emerald-400 to-teal-500"
                                            initial={{ scaleX: 0 }}
                                            animate={inView ? { scaleX: 1 } : { scaleX: 0 }}
                                            transition={{ delay: index * 0.2 + 0.5, duration: 0.6 }}
                                        />
