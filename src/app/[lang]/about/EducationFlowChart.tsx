    ...
    return (
        ...
        >
            ...
            <div className="relative">
                ...
                <motion.div 
                    className="absolute left-2.75 top-0 bottom-0 w-0.5 bg-linear-to-b from-indigo-300/0 via-indigo-500/50 to-indigo-300/0 dark:from-indigo-700/0 dark:via-indigo-400/30 dark:to-indigo-700/0 z-0 md:hidden origin-top"
                    variants={lineVariants}
                    initial="hidden"
                    animate={inView ? "visible" : "hidden"}
                />
