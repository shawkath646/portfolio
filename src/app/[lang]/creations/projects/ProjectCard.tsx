...
import { FaStar, FaCodeBranch, FaClock, FaGlobe, FaCode } from 'react-icons/fa';
    ...
    return (
        ...
        >
            ...
            <Link
                ...
                className="relative flex h-full flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border-2 border-gray-200 dark:border-gray-700 group-hover:border-transparent transition-all duration-300"
            >
                    <div className="flex h-full flex-1 flex-col p-5">
                    {/* Header */}
                    <header className="flex items-start gap-3 mb-3">
                        <div
                            className={`shrink-0 w-10 h-10 rounded-lg ${iconBg} flex items-center justify-center shadow-lg`}
                        >
                            <ProjectIcon
                    ...
                    {/* Footer */}
                    <footer className="mt-auto flex h-14 shrink-0 items-center justify-between border-t-2 border-gray-100 pt-2.5 dark:border-gray-700">
