...
import { getLifeMilestones } from '@/actions/mixed/getLifeMilestones';
...
export default async function Home({
  ...
  const [
    ...
    landingLanguagePack,
    skillsLanguagePack,
    orderNowLanguagePack,
    companyIntroLanguagePack,
    taskBoardLanguagePack,
    youtubeGridLanguagePack,
    gallerySnapshotLanguagePack,
    ...
    getLanguagePack(lang, "homepage-order-now-component"),
    getLanguagePack(lang, "homepage-company-intro-component"),
    getLanguagePack(lang, "homepage-task-board-component"),
    getLanguagePack(lang, "homepage-youtube-grid-component"),
    getLanguagePack(lang, "homepage-gallery-snapshot-component"),
    getLanguagePack(lang, "homepage-share-files-component"),
    getLanguagePack(lang, "homepage-life-timeline-component"),
  ]);
  ...
  return (
    ...
    >
      <LandingComponent languagePack={landingLanguagePack} />
      ...
      <div className="bg-linear-to-br from-blue-50 via-cyan-50 to-purple-100 dark:from-[#0a192f] dark:via-[#1e293b] dark:to-[#0f172a] transition-all duration-700 pt-10 px-4 md:px-0 relative overflow-hidden">
        ...
        <div aria-hidden className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-[38%] left-[20%] w-8 h-8 bg-linear-to-br from-yellow-300/20 to-orange-300/10 animate-pulse-fade"
        ...
        <div className="relative z-10">
            ...
            <div className="container mx-auto px-4 sm:px-6">
              ...
              >
                ...
                <div className="w-full lg:w-3/5 xl:w-[60%]">
                  <CompanyIntro languagePack={companyIntroLanguagePack} />
                </div>

                {/* Right Column: Tasks Board */}
                <div className="w-full lg:w-2/5 xl:w-[40%] lg:mt-12">
                  <TasksBoard languagePack={taskBoardLanguagePack} />
                </div>
              </div>
            </div>
          </div>
          ...
          {galleryImages.length > 0 && (
            <GallerySnapshot images={galleryImages} languagePack={gallerySnapshotLanguagePack} />
          )}

          <ShareFilesSection languagePack={shareFilesLanguagePack} />

          <LifeTimeline lifeEvents={lifeEvents} languagePack={lifeTimelineLanguagePack} />
