    ...
    >
      <div className="relative">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <motion.div
            className="absolute -top-20 -right-20 w-48 h-48 bg-linear-to-br from-blue-400/20 to-purple-400/20 dark:from-blue-600/10 dark:to-purple-600/10 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.5, 0.3]
            }}
          ...
          />
          <motion.div
            className="absolute -bottom-20 -left-20 w-48 h-48 bg-linear-to-br from-pink-400/20 to-indigo-400/20 dark:from-pink-600/10 dark:to-indigo-600/10 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.3, 1],
              opacity: [0.3, 0.6, 0.3]
            }}
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            >
              <motion.div
                className="absolute inset-0 bg-linear-to-br from-blue-500 to-purple-600 rounded-xl blur-lg opacity-50"
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.5, 0.7, 0.5]
                }}
              ...
              />
              <motion.div
                className="relative bg-linear-to-br from-blue-500 to-purple-600 p-3 rounded-xl shadow-lg"
            ...
            <div className="flex-1 text-center sm:text-left">
              <motion.div variants={itemVariants}>
                <motion.h1
                  className="text-2xl sm:text-3xl lg:text-4xl font-extrabold bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent mb-1"
                  animate={{
          ...
          <motion.div
            className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-purple-500/50 to-transparent"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
