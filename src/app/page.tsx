...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Home | Shawkat Hossain Maruf",
    description: "Welcome to Shawkat Hossain Maruf's portfolio - Explore innovative full-stack web applications, Android apps, and data analysis projects.",
  ...
  twitter: {
    ...
    title: "Home | Shawkat Hossain Maruf",
    description: "Welcome to Shawkat Hossain Maruf's portfolio - Full-stack developer and tech enthusiast",
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        <LoadingSkeleton type="text" className="max-w-md mx-auto" />
      </div>
...
function YouTubeLoading() {
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        <LoadingSkeleton type="text" className="max-w-sm mx-auto" />
      </div>
...
function CTALoading() {
  return (
    <div className="container mx-auto px-4 py-8">
      <LoadingSkeleton className="max-w-2xl mx-auto" />
    </div>
  );
}
...
export default async function Home() {
  ...
  const youtubeData = await fetchYouTubeVideos().catch(error => {
      ...
      <div className="bg-gradient-to-br from-blue-50 via-cyan-50 to-purple-100 dark:from-[#0a192f] dark:via-[#1e293b] dark:to-[#0f172a] transition-all duration-700 py-10 px-4 md:px-0 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <nav 
            ...
            className="pt-8 border-t border-gray-200/30 dark:border-gray-700/30"
          >
            <Pagination
              nextPage="/about"
