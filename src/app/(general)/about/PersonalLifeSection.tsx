...
export default function PersonalLifeSection() {
  ...
  return (
    <section 
      ref={ref} 
      className="relative py-20 px-6 overflow-hidden bg-linear-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20"
    ...
    >
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          ...
          >
            <div className="p-4 bg-linear-to-br from-blue-500 to-purple-600 rounded-full text-white shadow-lg">
          ...
          <motion.h2 
            ...
            className="text-2xl md:text-3xl font-bold text-center mb-6 bg-linear-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent"
          ...
          >
            <Link 
              ...
              className="group relative inline-flex items-center justify-center px-8 py-3 overflow-hidden font-medium transition-all bg-linear-to-br from-blue-500 to-purple-600 rounded-full hover:scale-105 transform text-white shadow-lg hover:shadow-xl active:scale-95"
