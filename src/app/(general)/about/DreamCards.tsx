                ...
                {goals.map((goal, i) => (
                    ...
                    >
                        <div className="h-full relative p-5 rounded-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group">
                            ...
                            >
                                <div className={`w-14 h-14 rounded-lg bg-linear-to-br ${goal.color} flex items-center justify-center text-white shadow-lg transform group-hover:rotate-6 group-hover:scale-110 transition-all duration-300`}>
                                    {goal.icon}
                                </div>
                            </motion.div>
