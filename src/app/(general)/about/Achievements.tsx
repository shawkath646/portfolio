    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                initial="initial"
                animate="animate"
                className="absolute inset-0 bg-linear-to-r from-transparent via-white/20 dark:via-white/10 to-transparent pointer-events-none"
                style={{ width: "50%" }}
            />
            ...
            <motion.div
                ...
                className={`w-12 h-12 rounded-xl bg-linear-to-br ${achievement.color} p-2.5 mb-3 shadow-md group-hover:shadow-lg transition-shadow duration-300`}
            >
            ...
            <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2 pt-1.5">
                    <div className="flex-1 h-px bg-linear-to-r from-gray-300 to-transparent dark:from-gray-600 dark:to-transparent" />
            ...
            {/* Hover glow effect */}
            <div className={`absolute inset-0 opacity-0 group-hover:opacity-10 bg-linear-to-br ${achievement.color} rounded-2xl transition-opacity duration-300 pointer-events-none`} />
        </motion.div>
    );
}
