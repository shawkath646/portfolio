...
import { FaGithub, FaStar, FaCodeBranch, FaExternalLinkAlt, FaUser, FaBriefcase, FaBook, FaHeart, FaRocket, FaFolder, FaClock, FaGlobe, FaCode } from 'react-icons/fa';
...
const ProjectCard = memo(({ project }: { project: CategorizedProject }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-br from-blue-400 via-purple-400 to-pink-400 dark:from-blue-500 dark:via-purple-500 dark:to-pink-500 rounded-2xl opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-500" aria-hidden="true" />
      ...
      >
        ...
        <div className={`h-1.5 bg-linear-to-r ${langColor?.gradient || 'from-gray-400 to-gray-500'}`} aria-hidden="true" />
        ...
        <div className="p-5">
          ...
          <header className="flex items-start gap-3 mb-3">
            <div className={`shrink-0 w-10 h-10 rounded-lg ${
              projectType === 'web' 
                ? 'bg-linear-to-br from-emerald-500 to-teal-600 dark:from-emerald-400 dark:to-teal-500' 
                : projectType === 'android'
            ...
            <FaExternalLinkAlt className="text-gray-400 group-hover:text-blue-500 dark:group-hover:text-blue-400 shrink-0 text-sm group-hover:scale-125 group-hover:rotate-12 transition-all duration-300" aria-hidden="true" />
          </header>
        ...
        <div className="absolute inset-0 bg-linear-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 pointer-events-none" aria-hidden="true" />
      </a>
    </motion.article>
  );
});
...
export default function ProjectsClient({ projectsData }: ProjectsClientProps) {
  ...
  return (
    <main
      id="main-content"
      className="min-h-screen bg-linear-to-br from-blue-50 via-cyan-50 to-purple-100 dark:from-[#0a192f] dark:via-[#1e293b] dark:to-[#0f172a] transition-all duration-700 py-16 px-4 md:px-6"
      role="main"
    ...
    >
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 text-transparent bg-clip-text bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400">
