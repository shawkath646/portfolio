                        ...
                        <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                                <span className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                                    ...
                                    {!passwordErrors.length ? <FiCheck size={12} /> : null}
                                </span>
                            ...
                            <li className="flex items-center gap-2">
                                <span className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                                    ...
                                    {!passwordErrors.uppercase ? <FiCheck size={12} /> : null}
                                </span>
                            ...
                            <li className="flex items-center gap-2">
                                <span className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                                    ...
                                    {!passwordErrors.lowercase ? <FiCheck size={12} /> : null}
                                </span>
                            ...
                            <li className="flex items-center gap-2">
                                <span className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                                    ...
                                    {!passwordErrors.number ? <FiCheck size={12} /> : null}
                                </span>
                            ...
                            <li className="flex items-center gap-2">
                                <span className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                                    ...
                                    {!passwordErrors.special ? <FiCheck size={12} /> : null}
                                </span>
