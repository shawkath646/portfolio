...
export default function AdminPassword() {
    ...
    const [apcOtp, setApcOtp] = useState("");
    ...
    const isValid = !!oldPassword && !Object.values(passwordErrors).some(Boolean) && newPassword === confirmPassword && !!apcOtp;
    ...
    return (
        ...
        >
            <header className="flex items-center gap-3 mb-4">
                <div
                    className="p-2 bg-linear-to-br from-pink-500 to-purple-600 rounded-xl backdrop-blur-sm shadow-md"
                    aria-hidden="true"
                >
                ...
                <div>
                    <h2
                        ...
                        className="text-lg sm:text-xl font-bold bg-linear-to-r from-gray-800 via-purple-800 to-pink-800 dark:from-white dark:via-purple-200 dark:to-pink-200 bg-clip-text text-transparent mb-0.5"
                    >
                        Admin Password
                    </h2>
            ...
            {status.type !== "idle" && (
                <motion.div
                    ...
                    className={`mb-4 p-3 rounded-lg backdrop-blur-sm ${status.type === "success"
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <p className={`text-xs font-medium ${status.type === "success"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="old-password" className="block text-xs font-medium text-gray-700 dark:text-gray-300">
                            Current Password
                        </label>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full pr-10 py-2 px-3 text-sm bg-white/90 dark:bg-gray-900/90 border rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-pink-400 focus:border-transparent transition-all ${passwordErrors.match && confirmPassword
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="apcOtp" className="block text-xs font-medium text-gray-700 dark:text-gray-300">
                            One Time Password (OTP)
                        </label>
                        <input
                            type="text"
                            id="apcOtp"
                            value={apcOtp}
                            onChange={(e) => setApcOtp(e.target.value)}
                            className="w-full pr-10 py-2 px-3 text-sm bg-white/90 dark:bg-gray-900/90 border rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-pink-400 focus:border-transparent transition-all border-purple-100 dark:border-purple-900/50"
                ...
                <div className="bg-linear-to-br from-gray-50/80 to-purple-50/80 dark:from-gray-900/30 dark:to-purple-900/20 backdrop-blur-sm rounded-lg p-3 border border-purple-100/20 dark:border-purple-800/20">
                    <h3 className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Password Requirements
                    </h3>
                    <ul className="space-y-1.5 text-xs">
                        <li className="flex items-center gap-2">
                            <span className={`shrink-0 w-4 h-4 rounded-full flex items-center justify-center ${!passwordErrors.length
                        ...
                        <li className="flex items-center gap-2">
                            <span className={`shrink-0 w-4 h-4 rounded-full flex items-center justify-center ${!passwordErrors.uppercase
                                ? "bg-linear-to-r from-green-500 to-emerald-500 text-white"
                                : "bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500"
                                }`}>
                        ...
                        <li className="flex items-center gap-2">
                            <span className={`shrink-0 w-4 h-4 rounded-full flex items-center justify-center ${!passwordErrors.lowercase
                                ? "bg-linear-to-r from-green-500 to-emerald-500 text-white"
                                : "bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500"
                                }`}>
                        ...
                        <li className="flex items-center gap-2">
                            <span className={`shrink-0 w-4 h-4 rounded-full flex items-center justify-center ${!passwordErrors.number
                                ? "bg-linear-to-r from-green-500 to-emerald-500 text-white"
                                : "bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500"
                                }`}>
                        ...
                        <li className="flex items-center gap-2">
                            <span className={`shrink-0 w-4 h-4 rounded-full flex items-center justify-center ${!passwordErrors.special
                                ? "bg-linear-to-r from-green-500 to-emerald-500 text-white"
                                : "bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500"
                                }`}>
